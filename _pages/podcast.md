...
<div style="height: 176px; width: 100%;">
  <iframe
    src="https://open.spotify.com/embed/episode/5A1a9Aaxxd9ZJERH34fWpI?utm_source=generator"
    style="display:block; border-radius: 12px; border: none; height: 152px; width: 100%;"
    allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"
    loading="lazy">
  </iframe>
  <a href="https://open.spotify.com/episode/5A1a9Aaxxd9ZJERH34fWpI"
     style="text-align: center; display: block; color: #A4ABB6; font-size: 12px; font-family: sans-serif; line-height: 16px; margin-top: 8px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
    Listen on Spotify
  </a>
</div>
...
<div style="height: 176px; width: 100%;">
  <iframe
    src="https://open.spotify.com/embed/episode/4AtrBuF2YuXhX26J7fpRlR?utm_source=generator"
    style="display:block; border-radius: 12px; border: none; height: 152px; width: 100%;"
    allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"
    loading="lazy">
  </iframe>
  <a href="https://open.spotify.com/episode/4AtrBuF2YuXhX26J7fpRlR"
     style="text-align: center; display: block; color: #A4ABB6; font-size: 12px; font-family: sans-serif; line-height: 16px; margin-top: 8px; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
    Listen on Spotify
  </a>
</div>
